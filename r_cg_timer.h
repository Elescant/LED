...
#define _01_TAU_EXTINT_RXD2                     (0x01U)   /* uses RXD2 pin as an external interrupt */
...
#define _01_WUTM_CLOCK_SUPPLY                   (0x01U)   /* supply input clock */

/* 
    WUTM Peripheral Clock Select Register (PCKSEL)
*/
/* WUTM operating clock control (WUTMCKE) */
#define _00_WUTM_CLOCK_DISABLE                  (0x00U)   /* stop supplying operating clock */
#define _04_WUTM_CLOCK_ENABLE                   (0x04U)   /* supply operating clock */
/* WUTM operating clock selection (WUTMCK1, WUTMCK0) */
#define _00_WUTM_INTERNAL_CLOCK0                (0x00U)   /* fIL */
#define _02_WUTM_INTERNAL_CLOCK2                (0x02U)   /* fMAIN/2^8 */
#define _03_WUTM_INTERNAL_CLOCK3                (0x03U)   /* fMAIN/2^12 */

/*
    WUTM Control Register (WUTMCTL)
*/
/* WUTM operation control (WUTMCE) */
#define _00_WUTM_OPERATION_DISABLE              (0x00U)   /* disable WUTM operation */
#define _80_WUTM_OPERATION_ENABLE               (0x80U)   /* enable WUTM operation */
...
#define TAU0_CHANNEL0_DIVISOR                   (4U)
